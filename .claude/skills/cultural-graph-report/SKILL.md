...
Output: `data/qq/cultural-graph/outputs/reports/cultural-graph-report-{suffix}.md` and optionally `funnel-plots.png`, `caterpillar-plots.png`
...
| `data/qq/cultural-graph/outputs/reports/caterpillar-plots.png` | Caterpillar plots (generated by `--caterpillar`) |
