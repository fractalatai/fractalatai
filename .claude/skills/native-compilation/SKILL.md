...
- `data/seed/legislation.parquet` (19,318 rows, 78 cols, ~12MB)
- `data/seed/law_edges.parquet` (1,035,305 rows, 8 cols, ~7MB)

These are generated by `duckdb < data/seed/export_legislation.sql` from JSONL source data. They are NOT checked into git.
