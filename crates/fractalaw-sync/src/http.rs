...
mod tests {
    ...
    fn annotation_json_roundtrip() {
        let ann = Annotation {
            ...
            regex_clause: "the duty of every employer to ensure".into(),
            confidence: 0.85,
    ...
    fn polished_entry_json_roundtrip() {
        let entry = PolishedEntry {
            ...
            ai_clause: "ensure health safety and welfare".into(),
    ...
    fn polished_entry_null_qualifier() {
        let json = r#"{
            ...
            "ai_clause": "conduct undertaking without risk",
            "qualifier": null,
            "clause_ref": "s.3",
            "confidence": 0.90,
    ...
    fn annotation_array_json_roundtrip() {
        let annotations = vec![
            Annotation {
                ...
                regex_clause: "duty of every employer to ensure".into(),
                confidence: 0.85,
                scraped_at: "2026-02-21T10:00:00Z".into(),
            },
            Annotation {
                ...
                regex_clause: "duty of every employee to take care".into(),
                confidence: 0.80,
                scraped_at: "2026-02-21T10:00:00Z".into(),
            },
        ];
